...
let AnalyticsGateway = class AnalyticsGateway {
    ...
    async handleAnalyticsUpdates(client, payload) {
        const analytics = await this.analyticsService.getAnalytics(payload.filter, payload.pagination);
...
__decorate([
    (0, websockets_1.SubscribeMessage)('analyticsUpdates'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsGateway.prototype, "handleAnalyticsUpdates", null);
