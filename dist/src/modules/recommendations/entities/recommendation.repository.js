...
let RecommendationRepository = class RecommendationRepository extends common_2.EntityRepository {
    constructor(model) {
        super(model);
    }
};
exports.RecommendationRepository = RecommendationRepository;
exports.RecommendationRepository = RecommendationRepository = __decorate([
